...
class FuzzyRegexViewController: ViewController {
    ...
    var analyzer = FuzzyRegexAnalyzer()
...
struct HostedFuzzyRegexViewController: UIViewControllerRepresentable {
    @Binding var aspectRatio: Double
    @Binding var showDialog: Bool
    @Binding var messages: [String]

    func makeUIViewController(context: Context) -> FuzzyRegexViewController {
        return FuzzyRegexViewController(aspectRatio: $aspectRatio,
                                        showDialog: $showDialog,
                                        messages: $messages)
    }

    func updateUIViewController(_ uiViewController: FuzzyRegexViewController, context: Context) {}
}
